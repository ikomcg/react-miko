    ...
    const loc_url = window.location.pathname;
        ...
        switch(loc_url.toLocaleLowerCase()){
            case '/about':
                ...
                paragraph.current = "I am an aspiring Junior Web Developer that has experience in creating projects that address specific issues such as the Learning Management System, presently pursuing my long-term career goal is to become a Web Developer."
                btn.current = <div className='flex item-center justify-center mt-10'>
                <a href='https://drive.google.com/file/d/1WT9dn3Twqi0dO-pJsp4QjoFXvCG7jx7k/view?usp=share_link' className='bg-bgviol text-white font-medium text-lg py-1 px-5 rounded-lg hover:scale-105 hover:cursor-pointer' rel="noreferrer" target='_blank'>my resume</a>
                </div>;
                image.current = about;
                break;
            case '/project':
